...
USE_SWIFTSHADER = SwiftShader_jll.is_available()
USE_SWIFTSHADER && (ENV["JULIA_VULKAN_LIBNAME"] = basename(SwiftShader_jll.libvulkan))
...
USE_SWIFTSHADER && @set_driver :SwiftShader
