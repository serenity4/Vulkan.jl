...
function test1()
    create(Ref{api.VkSamplerCreateInfo}, (:mipLodBias, 1f0,
...
function test2()
    create(Ref{api.VkSwapchainCreateInfoKHR}, (:imageArrayLayers, UInt32(0),
...
print_type(create(Vector{api.VkSwapchainCreateInfoKHR}, (:imageArrayLayers, UInt32(0),
        :queueFamilyIndexCount, UInt32(0),
        :pQueueFamilyIndices, Ptr{UInt32}(C_NULL),
        :clipped, UInt32(0)),(:imageArrayLayers, UInt32(0),
        :queueFamilyIndexCount, UInt32(0),
        :pQueueFamilyIndices, Ptr{UInt32}(C_NULL),
        :clipped, UInt32(0))
))
